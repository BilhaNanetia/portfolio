...
const Contact = () => {
  return (
    <section id="contact" className="bg-gray-100 py-5 sm:py-8">
      <div className="container mx-auto px-4">
        <div className="text-center mb-6">
          <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-gray-900">Contact Me</h2>
        ...
        <div className="text-center mt-6">
          <a href="/assets/files/Resume Bilha Leposo-6.pdf" download="Resume Bilha Leposo-6.pdf" className="flex items-center justify-center text-blue-500">
            ...
            <span className="text-lg  sm:text-xl font-semibold">Download My Resume</span>
          </a>
        </div>
      </div>
    </section>
